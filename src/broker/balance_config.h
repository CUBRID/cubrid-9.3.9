...
/*
 * balance_config.h - broker configuration utilities
 */
...
#define DEFAULT_BALANCE_NUM_PROXY	 1
#define DEFAULT_BALANCE_MAX_CLIENTS 	 256

#define DEFAULT_BALANCE_PROXY_LOG_MAX_SIZE	"100M"
...
enum t_proxy_log_mode_value
{
  ...
  PROXY_LOG_MODE_BALANCE_DETAIL = 4,
